...
def main():
    ...
    parser.add_argument('--protocol',type=Path,default=ROOT/'experiments/results/2026-09-21/protocol.json',help='Source/review-locked protocol; file paths inside it are repo-relative')
    ...
    protocol=load(args.protocol); spec=protocol['sources'][args.clip]
